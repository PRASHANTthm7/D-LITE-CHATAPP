...
export default function AppLoading() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center h-full w-full bg-canvas animate-in fade-in duration-500">
      <div className="w-16 h-16 rounded-2xl brand-grad flex items-center justify-center shadow-accent text-white mb-6 relative overflow-hidden">
